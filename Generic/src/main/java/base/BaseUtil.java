...
public class BaseUtil {
    ...
    public String browserstack_username= "mohammadschowdhu1";
    public String browserstack_accesskey = "xe43AiRGRN19M6NnJsyR";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
        ...
        System.setProperty("webdriver.chrome.driver","..C:\\Users\\chowd\\Desktop\\blue\\BlueGrass\\Generic\\browserDriver\\chrome.exe");
        if(useCloudEnv==true){
